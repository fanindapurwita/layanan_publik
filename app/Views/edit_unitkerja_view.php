...
<div class="app-content">
          ...
          <div class="container-fluid">
            ...
            <div class="card card-warning card-outline mb-4">
                  ...
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form method="post" action="<?= route_to('simpanunit') ?>">
                    <!--begin::Body-->
                    <div class="card-body">
                      <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Unit Kerja</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="nama_unitkerja" id="inputEmail3" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Kepala Unit Kerja</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="kepala_unitkerja" />
                        </div>
                      </div>
                    </div>
                    <!--end::Body-->
